...
/**
 * WebHome 扩展用户来源存储（代码/链接/文件三种形态），以 JSON 存于 Prefers。
 */
public class WebHomeExtensionSourceStore {

    private static final String KEY = "web_home_extension_sources";
    ...
    private static JsonObject linkObject(String id, String name, String runAt, String link, String match) {
        ...
        if (WebHomeExtension.isScriptUrl(link)) object.add("js", App.gson().toJsonTree(java.util.Collections.singletonList(link)));
