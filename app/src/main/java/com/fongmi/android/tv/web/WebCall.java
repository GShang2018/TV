...
public class WebCall {
    ...
    private static final OkHttpClient CLIENT = new OkHttpClient.Builder().followRedirects(true).followSslRedirects(true).dns(OkHttp.dns()).proxySelector(OkHttp.selector()).build();
    ...
    public static String request(JsonObject payload) {
        ...
        try {
            ...
            SpiderDebug.log("webhome-net", "%s %s include=%s timeout=%ss", request.method(), request.url(), include, timeout);
