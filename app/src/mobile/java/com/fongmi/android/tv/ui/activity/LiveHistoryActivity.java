...
public class LiveHistoryActivity extends BaseActivity implements LiveChannelAdapter.OnClickListener {
    ...
    private void onDelete(View view) {
        ...
        new MaterialAlertDialogBuilder(this)
                ...
                .setPositiveButton(R.string.select_delete, (dialog, which) -> {
                    for (Channel item : mAdapter.getSelected()) LiveHistory.delete(item.getName());
                    getData();
                }).show();
    }
    ...
    public void onSelectChanged(int count) {
        ...
        mBinding.title.setText(select ? getString(R.string.select_count, count) : getString(R.string.live_history));
    }
