...
public class CacheTimeDialog {
    ...
    public static CacheTimeDialog create(Fragment fragment) {
        return new CacheTimeDialog(fragment);
    }

    public CacheTimeDialog(Fragment fragment) {
        this.callback = (CacheTimeCallback) fragment;
        this.binding = DialogCacheTimeBinding.inflate(LayoutInflater.from(fragment.getContext()));
    }
